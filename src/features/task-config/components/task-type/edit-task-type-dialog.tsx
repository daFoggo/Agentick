...
interface IEditTaskTypeDialogProps {
	status: TTaskType;
	open: boolean;
	onOpenChange: (open: boolean) => void;
}

export const EditTaskTypeDialog = ({
	status,
	open,
	onOpenChange,
}: IEditTaskTypeDialogProps) => {
	const { updateType } = useTaskConfigMutations();
	...
	const form = useForm({
		...
		} as TTaskTypeUpdateInput,
		validators: { onSubmit: TaskTypeUpdateSchema },
					...
					<DialogFooter>
						...
						<form.Subscribe
							...
							children={([canSubmit]) => (
								<Button
									type="submit"
									disabled={!canSubmit || updateType.isPending}
								>
