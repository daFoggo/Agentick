...
import { getInboxStatsFn, getInboxListFn } from "./functions"
import type { GetInboxStatsInput, TInboxStats, TInboxItem, TInboxStatus } from "./schemas"

export const inboxKeys = {
  all: ["inbox"] as const,
  stats: () => [...inboxKeys.all, "stats"] as const,
  list: (status?: TInboxStatus, isRead?: boolean, isBookmarked?: boolean) => [...inboxKeys.all, "list", status, isRead, isBookmarked] as const,
}
